  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (file) {
        ...
        // Text API (generates documentation only)
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-slate-900 flex items-center justify-center px-6 py-12 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-5xl">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
          className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl p-8 shadow-2xl transition-all duration-500 hover:shadow-indigo-500/40 hover:scale-[1.01]">
...
{responseData && (
  ...
  >
    ...
    {/* Always show generated documentation */}
    {responseData.generatedDoc && (
    ...
    {/* Show PDF button ONLY if user uploaded a file */}
    {file && (responseData.downloadUrl || responseData.id) && (
      <button
